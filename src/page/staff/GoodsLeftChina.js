...
export default function GoodsLeftChina() {
    ...
    const onSubmit = (data) => {
        ...
        if (warehouse && warehouse._id) {
            SEND_PUT_REQUEST(API_ADMIN.leftChina, { ...data, warehouseId: warehouse._id }).then(res => {
                setSaving(false);
                if (res.status === 200) {
                        ...
                        currentStep === 1 && <div className="w-full flex-col max-w-xl">
                            ...
                            <div className="grid md:grid-cols-2 items-center justify-center  gap-4  p-4">
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    <label>Price (¥) *</label>
                                    <input type="number" step={0.01} className="input input-bordered rounded"  {...register('priceY')}  required />
                                </div>
                                <div className="flex flex-col gap-2">
                                    <label>Title</label>
                                ...
                                <div className=" w-full mt-4 md:col-span-2 justify-center flex">
                                    ...
                                    <button className={`btn btn-info w-full ${saving ? 'loading' : ''}`} type="submit">Left From China</button>
                                </div>
                            </div>
                        </div>
                    }
